...
| `wikidata_capitals.ttl` | Knowledge graph / geographic facts | Facts for Q90 (Paris), Q84 (London), Q64 (Berlin) from [Wikidata](https://www.wikidata.org/) via [Wikidata Query Service](https://query.wikidata.org/) (May 2026). Populations and country labels change over time. | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) |
