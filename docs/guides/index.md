...
These guides explain how to use TripleModel **0.2.x** in order of increasing complexity. Each guide is self-contained, but later guides assume you have read {doc}`01-getting-started`.
...
| 3 | {doc}`03-multi-valued-fields` | Lists, sets, `on_duplicate` |
